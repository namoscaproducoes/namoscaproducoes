...
<head>
  ...
  <title>Rádio Social Plus Brasil — Ao vivo</title>
  ...
  <link rel="stylesheet" href="assets/style.css?v=ads1">
  <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-3155071186177332" crossorigin="anonymous"></script>
...
<body>
  ...
  <main>
    <section class="hero container">
      ...
      <div class="now-card"><div class="now-label"><span class="equalizer"><b></b><b></b><b></b><b></b></span> TOCANDO AGORA</div><div class="art-wrap"><img id="albumArt" src="assets/logo.png" alt="Capa do álbum"><div class="art-glow"></div></div><div class="track-info"><div><h2 id="trackTitle">Rádio Social Plus Brasil</h2><p id="trackArtist">A sua rádio, a qualquer hora</p></div><span class="signal">●</span></div><div class="player"><button class="play-btn" id="playBtn" aria-label="Tocar rádio">▶</button><div class="player-details"><div class="progress"><span></span></div><div class="player-times"><small id="playerStatus">Pronto para ouvir</small><small>AO VIVO</small></div></div><label class="volume">◖<input id="volume" type="range" min="0" max="1" step=".01" value=".8"></label></div><audio id="radio" preload="none" src="<?php echo htmlspecialchars(RADIO_STREAM); ?>"></audio></div>
    </section>
    <section class="content-grid container"><div class="main-col"><section class="vote-section"><div class="section-head"><div><p class="eyebrow">A comunidade decide</p><h2>O que você achou<br>dessa música?</h2></div><div class="vote-count"><strong id="voteCount">0</strong><span>votos na faixa atual</span></div></div><div class="vote-actions"><button class="vote-btn like" data-vote="like"><span>♡</span><div><b>Gostei!</b><small>Quero ouvir de novo</small></div></button><button class="vote-btn dislike" data-vote="dislike"><span>♧</span><div><b>Não curti</b><small>Ajude a gente a escolher</small></div></button></div></section><section class="top-section"><div class="section-title-row"><div><p class="eyebrow">A preferência de quem ouve</p><h2>AS TOP 5 <em>MAIS VOTADAS</em></h2></div><span class="period">ESTA SEMANA　⌄</span></div><div id="topList" class="top-list"></div></section></div><aside class="side-col"><section class="activity"><div class="side-title"><span class="live-dot"></span><div><p class="eyebrow">Em tempo real</p><h3>QUEM ESTÁ VOTANDO</h3></div></div><div id="activityList"></div><div class="activity-note">Os votos da comunidade aparecem aqui na hora.</div></section><section class="community-card"><span>✦</span><h3>Faça parte<br>da nossa comunidade</h3><p>Cadastre-se para votar, acompanhar seu histórico e ajudar a escolher a programação.</p><a href="register.php" target="_blank">Criar minha conta　→</a></section></aside></section>
  </main>
  ...
  <aside class="ad-lateral" aria-label="Publicidade"><ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-3155071186177332" data-ad-slot="9370447732" data-ad-format="auto" data-full-width-responsive="true"></ins></aside>
  <div class="ad-rodape" aria-label="Publicidade"><ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-3155071186177332" data-ad-slot="8946672256" data-ad-format="auto" data-full-width-responsive="true"></ins></div>
  ...
  <script>window.RADIO_CONFIG=<?php echo json_encode(['apiBase'=>'api','lastfmKey'=>LASTFM_API_KEY,'stream'=>RADIO_STREAM]); ?>;</script><script src="assets/app.js?v=ads1"></script>
</body></html>
